...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<airbrake-ruby>.freeze, ["~> 4.13"])
      ...
      s.add_development_dependency(%q<parallel>.freeze, ["= 1.13.0"])
      s.add_development_dependency(%q<minitest>.freeze, ["= 5.11.3"])
      s.add_development_dependency(%q<rack-cache>.freeze, ["= 1.9.0"])
      ...
      s.add_dependency(%q<airbrake-ruby>.freeze, ["~> 4.13"])
      ...
      s.add_dependency(%q<parallel>.freeze, ["= 1.13.0"])
      s.add_dependency(%q<minitest>.freeze, ["= 5.11.3"])
      s.add_dependency(%q<rack-cache>.freeze, ["= 1.9.0"])
